      ...
      <section id="hospitalsList">
        <div v-for="(cardData,index) in displayData" :key="index">
            <v-card
              ...
              <div class="px-4">
                <v-chip-group v-model="selection" class="disabled-chip-group">
              ...
              <v-card-actions>
                <v-btn
                  color="blue"
                  variant="text"
                  @click="navigateToDetails(cardData.id, cardData.hospital_name, cardData.department_name, cardData.city)"
                  to="/hospital/filter1/"
                  >
                  View
                </v-btn>
...
methods: {
  ...
  navigateToDetails(id, hospital_name,department_name, city) {
      this.$router.push({ name: "details", params: { id, hospital_name,department_name, city} });
    },
  sendEmail(e) {
    try {
