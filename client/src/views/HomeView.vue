        ...
        <v-row>
          <v-col cols="5">
            <div style="position: relative" class="mt-16">
              ...
              <!-- <v-btn tile dark class="text-yellow mt-8" variant="outlined" style="font-family: 'Times New Roman', Times, serif;">
                Contact us
              </v-btn> -->
            </div>
          </v-col>
      ...
      <v-col cols="12" class="mt-16" id="about">
        <div>
          <v-row>
            <v-col cols="12" sm="6">
              <div class="egg">
                <v-img src="../assets/logo.png" max-height="200" class="center image"></v-img>
              </div>
            </v-col>
            <v-col cols="12" sm="6">
...
<style scoped>
/* Assuming the NavBar component has a class named "nav-bar" */
.v-container {
